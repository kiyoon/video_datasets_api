...
import pickle
import os
from ..beoid.read_annotations import read_all_annotations
...
Wray_class_key_to_BEOID_class_keys = MappingProxyType({
 ...
 'scoop_spoon': ['scoop_spoon+jar', 'scoop_jar+spoon', 'scoop_spoon'],
 'stir_spoon': ['stir_cup+spoon', 'stir_spoon', 'stir_spoon+cup'],
